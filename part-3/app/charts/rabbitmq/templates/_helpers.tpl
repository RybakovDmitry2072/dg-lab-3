...
{{- default ( printf "%s-secret" .Chart.Name ) .Values.global.secret.rabbitmq | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- default ( printf "%s-configmap" .Chart.Name ) .Values.global.config.rabbitmq | trunc 63 | trimSuffix "-" }}
{{- end }}
